...
&#35;8 | Now that you've got the script opened, you're all set to get started. Place your cursor at the end of a line and run it by pressing `CTRL+ENTER` (`CMD+ENTER` on Mac) | <img height="300px;" src="screenshots/run-command.png" />
